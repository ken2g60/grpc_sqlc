...
const (
	...
	UserService_UpdateUser_FullMethodName     = "/main.UserService/UpdateUser"
	UserService_GetUser_FullMethodName        = "/main.UserService/GetUser"
	UserService_DeactivateUser_FullMethodName = "/main.UserService/DeactivateUser"
)
...
type UserServiceClient interface {
	...
	DeactivateUser(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) DeactivateUser(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	DeactivateUser(context.Context, *UserIdRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) DeactivateUser(context.Context, *UserIdRequest) (*UserResponse, error) {
...
func _UserService_DeactivateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).DeactivateUser(ctx, req.(*UserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
